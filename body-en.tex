...
the latest features of Rameau without, however, present the
...
Section \ref{sec:system} gives an overview of how rameau works,
section \ref{sec:algorithms} describes briefly the algorithms
implemented in Rameau, section \ref{sec:comp-music} presents the main
musicological features implemented in the system, finally, section
\ref{sec:conclusion} contains some concluding remarks and directions
for future work.
